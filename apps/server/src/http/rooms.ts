...
// list with resolved display names. The seat query joins `profiles` in a
// second round-trip rather than via PostgREST's relationship syntax to keep
// the Database type stub in supabase.ts minimal; two selects is cheap
// compared to the latency of a single request.
// ---------------------------------------------------------------------------
